 ...
 path: '/donations',
   icon: (
...
},
    {
      ...
      icon: (
        <svg className="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M17.5 4.16667H2.5C1.58 4.16667 0.833333 4.91333 0.833333 5.83333V14.1667C0.833333 15.0867 1.58 15.8333 2.5 15.8333H17.5C18.42 15.8333 19.1667 15.0867 19.1667 14.1667V5.83333C19.1667 4.91333 18.42 4.16667 17.5 4.16667ZM17.5 14.1667H2.5V5.83333H17.5V14.1667Z" />
        </svg>
    ),
    },
    {
title: 'Inventory',
      ...
      icon: (
  <svg className="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M16.6667 2.5H3.33333C2.41286 2.5 1.66667 3.2462 1.66667 4.16667V15.8333C1.66667 16.7538 2.41286 17.5 3.33333 17.5H16.6667C17.5871 17.5 18.3333 16.7538 18.3333 15.8333V4.16667C18.3333 3.2462 17.5871 2.5 16.6667 2.5Z" />
          <path d="M6.66667 7.5H13.3333V9.16667H6.66667V7.5ZM6.66667 10.8333H13.3333V12.5H6.66667V10.8333Z" fill="white"/>
        </svg>
      ),
    },
    {
      ...
      icon: (
      <svg className="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M10 10C12.3012 10 14.1667 8.13452 14.1667 5.83333C14.1667 3.53215 12.3012 1.66667 10 1.66667C7.69881 1.66667 5.83333 3.53215 5.83333 5.83333C5.83333 8.13452 7.69881 10 10 10Z" />
          <path d="M10 11.6667C6.54822 11.6667 3.75 12.9641 3.75 14.5833V16.6667C3.75 17.1269 4.12309 17.5 4.58333 17.5H15.4167C15.8769 17.5 16.25 17.1269 16.25 16.6667V14.5833C16.25 12.9641 13.4518 11.6667 10 11.6667Z" />
   </svg>
      ),
    },
    {
      ...
      icon: (
        <svg className="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M13.3333 5H16.6667V6.66667H15V17.5C15 18.4205 14.2538 19.1667 13.3333 19.1667H6.66667C5.7462 19.1667 5 18.4205 5 17.5V6.66667H3.33333V5H6.66667V2.5C6.66667 1.57953 7.41286 0.833333 8.33333 0.833333H11.6667C12.5871 0.833333 13.3333 1.57953 13.3333 2.5V5ZM6.66667 6.66667V17.5H13.3333V6.66667H6.66667ZM8.33333 2.5V5H11.6667V2.5H8.33333Z" />
        </svg>
      ),
    },
    {
