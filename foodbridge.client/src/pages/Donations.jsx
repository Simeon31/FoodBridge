...
const DonationsPage = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const payload = {
                ...
                receivedBy: parseInt(formData.receivedBy) || 1, 
    ...
    const columns = [
        ...
        },
        {
            header: 'Status',
            render: (row) => (
                <span className={`inline-flex rounded-full bg-opacity-10 py-1 px-3 text-sm font-medium ${row.status === 'Approved' ? 'bg-success text-success' :
                    ...
                    <div className="w-full max-w-2xl rounded-lg bg-white dark:bg-boxdark p-6 shadow-lg">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <span className={`inline-flex rounded-full bg-opacity-10 py-1 px-3 text-sm font-medium ${selectedDonation.status === 'Approved' ? 'bg-success text-success' :
